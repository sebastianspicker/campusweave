...
def _check_catalogs(args: argparse.Namespace, catalog: str, machine_catalog: str | None, spec: Mapping[str, Any], raw: bytes) -> int:
...
def _write_catalogs(args: argparse.Namespace, catalog: str, machine_catalog: str | None, spec: Mapping[str, Any], raw: bytes) -> int:
